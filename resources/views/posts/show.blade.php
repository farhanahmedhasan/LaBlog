        ...
        <div class="w-4/5 mx-auto">
            ...
            <div class="pt-10 pb-10 text-gray-900 text-xl">
                <p class="font-bold text-2xl text-black pt-10">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat, sed, velit. Aliquid autem commodi
                    cupiditate, eos exercitationem facilis ipsum iure nam praesentium quae, qui sit temporibus tenetur
